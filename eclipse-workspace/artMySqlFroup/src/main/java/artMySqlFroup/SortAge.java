...
public class SortAge {
	   ...
	   static final String data = "SELECT * FROM SalaryofEmployee ORDER BY age DESC;";
	   ...
	   public static void main(String args[]) 
		...
		try{  
			...
			ResultSet rs=st.executeQuery("SELECT * FROM SalaryofEmployee ORDER BY age DESC;"); 
			
		    System.out.println("Sorting employee by their Age...");
